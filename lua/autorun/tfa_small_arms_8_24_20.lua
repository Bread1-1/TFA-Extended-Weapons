...
if CLIENT then
	...
	killicon.Add( "tfa_kolibri", "vgui/hud/kolibri", icol  )
end
//MP40
sound.Add({
	name = 			"mp40.single",
...
sound.Add({
	...
	channel = 		CHAN_USER_BASE+10,
	volume = 		1.0,
	sound = 			"weapons/p90_smg/p90-1.mp3"
})
...
sound.Add(
{
	...
	channel = 		CHAN_USER_BASE+10,
	volume = 		1.0,
	sound = 			"weapons/kolibri/kolibrishot.mp3"
} )

sound.Add(
{
	name = 			"weapon_kolibritfa.clipout",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/kolibri/kolibrimagout.mp3"
} )

sound.Add(
{
	name = 			"weapon_kolibritfa.clipin",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/kolibri/kolibrimagin.mp3"
} )
