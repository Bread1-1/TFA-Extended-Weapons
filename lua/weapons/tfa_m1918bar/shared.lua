...
SWEP.Gun = ("tfa_m1918bar") -- must be the name of your swep but NO CAPITALS!
...
SWEP.MoveSpeed = .90 --Multiply the player's movespeed by this.
...
SWEP.Primary.Range = 52500 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
